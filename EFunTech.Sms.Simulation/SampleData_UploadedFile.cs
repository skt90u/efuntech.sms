...
{
    public class SampleData_UploadedFile : SampleData 
    {
        ...
        static SampleData_UploadedFile()
        {
            factory = AutoPocoContainer.Configure(x =>
            {
                ...
                x.AddFromAssemblyContainingType<UploadedFile>();

                //x.Include<UploadedFile>()
        ...
        {
            // SampleData_UploadedFile.SeedEntity(context, user)
            context.SaveChanges();
        }
    }
}

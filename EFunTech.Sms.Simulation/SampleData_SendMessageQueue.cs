...
{
    public class SampleData_SendMessageQueue : SampleData 
    {
        ...
        static SampleData_SendMessageQueue()
        {
            factory = AutoPocoContainer.Configure(x =>
            {
                ...
                x.AddFromAssemblyContainingType<SendMessageQueue>();

                //x.Include<SendMessageQueue>()
        ...
        {
            // SampleData_SendMessageQueue.SeedEntity(context, user)
            context.SaveChanges();
        }
    }
}

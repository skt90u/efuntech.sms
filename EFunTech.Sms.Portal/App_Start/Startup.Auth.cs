...
namespace EFunTech.Sms.Portal
{
    public partial class Startup
    {
        ...
        {
            ISystemParameters systemParameters = new SystemParameters();
            int expireTimeSpan = systemParameters.ExpireTimeSpan;
            int validateInterval = systemParameters.ValidateInterval;
            ...
            {
                ExpireTimeSpan = TimeSpan.FromMinutes(expireTimeSpan), //  Identity Automatic Logout

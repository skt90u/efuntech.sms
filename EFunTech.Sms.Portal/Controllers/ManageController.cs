...
{
    [Authorize]
    public class ManageController : MvcControllerBase
    {
        ...
        public ManageController(ApplicationUserManager userManager, ApplicationSignInManager signInManager,IUnitOfWork unitOfWork, ILogService logService)

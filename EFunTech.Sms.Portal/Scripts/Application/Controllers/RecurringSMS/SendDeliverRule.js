(function (window, document) {
    ...
    angular.module('app').controller('SendDeliverRule', ['$scope', 'CurrentUserManager', '$http', 'uiGridConstants', '$modal', '$log', 'CrudApi', 'WebApi', 'SchemaFormFactory', 'GlobalSettings', 'LookupApi', 'ValidationApi', '$q', 'SchemaFormHelper', '$translate', 'dialogs',
        ...
        $scope.search = function () {
            var criteria = {
                SendTimeType: SendTimeTypeOptions.Deliver,
        ...
        $scope.editRow = function (rowEntity) {
            ...
            var gridOptions = {
                ...
                //},
                {
                    name: 'SendTime',
                    displayName: '預約時間',
                    cellTemplate: '<div class="ui-grid-cell-contents">{{(row.entity.SendTime || grid.appScope.SendMessageRule.SendTime) | UtcToLocalTimeFilter: "YYYY/MM/DD HH:mm:ss" }}</div>',
                },
                {
                    name: 'MessageCost',
                    displayName: '發送扣點'

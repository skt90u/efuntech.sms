...
{
    public class SyncLookupApi: IJob
    {
        ...
        {
            Type type = typeof(EFunTech.Sms.Portal.Controllers.LookupApiController);
        ...
        private List<string> CreateFileContent()
        {
            ...
            lines.Add(string.Format("    angular.module('app').factory('LookupApi', ['$http', '$log', 'toaster', function ($http, $log, toaster) {{"));
            lines.Add(string.Format(""));
            ...
            lines.Add(string.Format(""));
            lines.Add(string.Format("                var url = '/api/LookupApi/' + functionName;"));
            lines.Add(string.Format(""));
            ...
            lines.Add(string.Format("                    toaster.pop({{"));
            lines.Add(string.Format("                        type: 'error',"));
            lines.Add(string.Format("                        title: functionName,"));
            lines.Add(string.Format("                        body: '查詢失敗',"));
            lines.Add(string.Format("                        showCloseButton: true,"));
            lines.Add(string.Format("                    }});"));
            ...
            lines.Add(string.Format("        }});"));
            lines.Add(string.Format(""));
            lines.Add(string.Format("        return functions; // LookupApi"));
            lines.Add(string.Format("    }}]);"));
            lines.Add(string.Format(""));
        ...
        public void Execute()
        {
            ...
            var filePath = SchemaInfo.GetLookupApiFilePath(PortalDir);
